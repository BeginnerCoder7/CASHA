    ...
    if (isset($_SESSION['username'])) {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['depositAmount'])) {
            ...
            if ($bankbalance < $depositAmount) {
                ...
                $stmt_update->bind_param("dds", $depositAmount, $depositAmount, $_SESSION['username']);
                ...
                if ($stmt_update->execute()) {
                    ...
                    $stmt_transaction->bind_param("sssd", $transaction_id, $_SESSION['username'], $_SESSION['username'], $depositAmount);
                    $stmt_transaction->execute();

                    echo '<script>alert("Successfully deposited to your account");</script>';
...
<div class="container">
    ...
    <div class="bank1">
        <div class="bank-details" onclick="showDepositForm()">
    ...
    <div id="depositModal" class="modal">
        <div class="modal-content">
            ...
            <form method="post" action="deposit.php">
                <input type="text" name="depositAmount" id="depositAmount" placeholder="Enter amount">
    ...
    <script>
        ...
        function depositToAccount() {
            ...
            if (amount !== '') {
                alert('Successfully deposited to your account');
                closeDepositForm();
            } else {
